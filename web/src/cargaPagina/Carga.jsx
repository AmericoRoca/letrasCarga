...
export const Carga = () => {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Animar cada línea de los paths (dibuja las líneas)
        paths.forEach(path => {
            const length = path.getTotalLength();
            gsap.set(path, { strokeDasharray: length, strokeDashoffset: length, scale:1 });
            gsap.set("#navbar", { opacity:0, x: -300 });
        ...
        // Cuando todas las líneas hayan terminado, rellena el objeto con color negro
        tl.to(paths, { fill: "#231f20", duration: 1 }, "+=0.5");
      
      
        tl.to(paths, {opacity: 0, delay:0.7 }, "+=0.5");
